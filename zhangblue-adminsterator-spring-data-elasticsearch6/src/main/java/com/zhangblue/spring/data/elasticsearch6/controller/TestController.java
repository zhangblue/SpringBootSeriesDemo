package com.zhangblue.spring.data.elasticsearch6.controller;

import com.alibaba.fastjson.JSONObject;
import com.zhangblue.spring.data.elasticsearch6.mapping.Student;
import com.zhangblue.spring.data.elasticsearch6.service.ServiceExample;
...
//        .get(id.toString(), Student.class, IndexCoordinates.of("index_student"));
    Student student = serviceExample.getDataById(id);
    return student;
  }

  @GetMapping("/student/search")
  public JSONObject searchData() {
    return serviceExample.searchQueryData("index_student");
  }
